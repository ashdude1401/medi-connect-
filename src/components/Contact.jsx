...
const Contact = () => {
  return (
    <div className="bg-white px-8 py-12 text-gray-100" id="contactUs">
      <div className="mx-auto grid max-w-screen-xl grid-cols-1 gap-8 rounded-lg bg-gray-100 px-8 py-16 text-gray-900 shadow-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
        <div className="flex flex-col justify-between">
          <div>
            <h2 className="text-4xl title-font font-bold font-heading lg:text-5xl">
              Contact Us!
            </h2>
            ...
            >
              <defs>
                ...
                >
                  ...
                  <path d="M34.88,29.7  2v.19a1,1,0,0,0,2,0v-.19a1,1,0,0,0-2,0Z" />
        ...
        <div className="">
          <div>
            ...
            <input
              className="focus:shadow-outline mt-2 w-full rounded-lg bg-white border border-solid border-gray-500 p-3 text-gray-900 focus:outline-none"
              type="text"
          ...
          <div className="mt-8">
            ...
            <textarea className="focus:shadow-outline mt-2 h-32 w-full rounded-lg bg-white border border-solid border-gray-500 p-3 text-gray-900 focus:outline-none"></textarea>
          </div>
          <div className="mt-8">
            <button className="focus:shadow-outline w-full rounded-lg bg-violet-500 p-3 text-sm font-bold uppercase tracking-wide text-gray-100 focus:outline-none hover:bg-violet-600">
              Send Message
            </button>
          </div>
        </div>
